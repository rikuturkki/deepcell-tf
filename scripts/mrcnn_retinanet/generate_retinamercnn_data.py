...
# output filepaths
RET_DATA_DIR = '/data/data/tissues/mibi/retinanet'
...
if __name__ == '__main__':
    ...
    if not os.path.exists(RET_DATA_DIR):                        # /data/data/tissues/mibi/retinanet
        os.mkdir(RET_DATA_DIR)
