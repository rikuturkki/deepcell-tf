...
from scripts.recurr_gru.conv_gru_layer import ConvLSTM2D
...
def feature_net_LSTM(input_shape,
                    receptive_field=61,
                    n_frames=5,
                    n_features=3,
                    n_channels=1,
...
def create_and_train_fgbg(data_filename, train_dict):
    ...
    fgbg_model.save_weights(fgbg_lstm_weights_file)
...
if __name__== "__main__":
    ...
    n_epoch = 7  # Number of training epochs
