#flysampling classification new, 61x61 sampling
...
#withrot
MODEL_NAME = '2018-08-16_mibi_61x61_pxR3_frot_lib5_class_channels_last_sample__0.h5'
...
def train_model_on_training_data():
    ...
    if DATA_OUTPUT_MODE == 'sample':
        ...
        the_model = bn_feature_net_61x61				#changed to 61x61
