...
#define __PYX_HAVE__deepcell__utils__compute_overlap
#define __PYX_HAVE_API__deepcell__utils__compute_overlap
/* Early includes */
#include <string.h>
#include <stdio.h>
...
/* Module declarations from 'deepcell.utils.compute_overlap' */
static __Pyx_TypeInfo __Pyx_TypeInfo_double = { "double", NULL, sizeof(double), { 0 }, 0, 'R', 0, 0 };
#define __Pyx_MODULE_NAME "deepcell.utils.compute_overlap"
extern int __pyx_module_is_main_deepcell__utils__compute_overlap;
int __pyx_module_is_main_deepcell__utils__compute_overlap = 0;

/* Implementation of 'deepcell.utils.compute_overlap' */
...
static const char __pyx_k_deepcell_utils_compute_overlap[] = "deepcell.utils.compute_overlap";
static const char __pyx_k_numpy_core_multiarray_failed_to[] = "numpy.core.multiarray failed to import";
static const char __pyx_k_unknown_dtype_code_in_numpy_pxd[] = "unknown dtype code in numpy.pxd (%d)";
static const char __pyx_k_Format_string_allocated_too_shor[] = "Format string allocated too short, see comment in numpy.pxd";
static const char __pyx_k_Non_native_byte_order_not_suppor[] = "Non-native byte order not supported";
static const char __pyx_k_deepcell_utils_compute_overlap_p[] = "deepcell/utils/compute_overlap.pyx";
...
static PyObject *__pyx_n_s_deepcell_utils_compute_overlap;
static PyObject *__pyx_kp_s_deepcell_utils_compute_overlap_p;
...
static PyObject *__pyx_pf_8deepcell_5utils_15compute_overlap_compute_overlap(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_boxes, PyArrayObject *__pyx_v_query_boxes); /* proto */
...
/* "deepcell/utils/compute_overlap.pyx":13
 * 
 * 
 * def compute_overlap(             # <<<<<<<<<<<<<<
...
/* Python wrapper */
static PyObject *__pyx_pw_8deepcell_5utils_15compute_overlap_1compute_overlap(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_8deepcell_5utils_15compute_overlap_compute_overlap[] = "\n    Args\n        a: (N, 4) ndarray of float\n        b: (K, 4) ndarray of float\n\n    Returns\n        overlaps: (N, K) ndarray of overlap between boxes and query_boxes\n    ";
static PyMethodDef __pyx_mdef_8deepcell_5utils_15compute_overlap_1compute_overlap = {"compute_overlap", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_8deepcell_5utils_15compute_overlap_1compute_overlap, METH_VARARGS|METH_KEYWORDS, __pyx_doc_8deepcell_5utils_15compute_overlap_compute_overlap};
static PyObject *__pyx_pw_8deepcell_5utils_15compute_overlap_1compute_overlap(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_L3_error:;
  __Pyx_AddTraceback("deepcell.utils.compute_overlap.compute_overlap", __pyx_clineno, __pyx_lineno, __pyx_filename);
  ...
  __pyx_r = __pyx_pf_8deepcell_5utils_15compute_overlap_compute_overlap(__pyx_self, __pyx_v_boxes, __pyx_v_query_boxes);
...
static PyObject *__pyx_pf_8deepcell_5utils_15compute_overlap_compute_overlap(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_boxes, PyArrayObject *__pyx_v_query_boxes) {
  ...
  /* "deepcell/utils/compute_overlap.pyx":25
 *         overlaps: (N, K) ndarray of overlap between boxes and query_boxes
 *     """
 ...
 */
  ...
  /* "deepcell/utils/compute_overlap.pyx":26
 *     """
 *     cdef unsigned int N = boxes.shape[0]
 *     cdef unsigned int K = query_boxes.shape[0]             # <<<<<<<<<<<<<<
 *     cdef np.ndarray[double, ndim=2] overlaps = np.zeros((N, K), dtype=np.float64)
 ...
 */
  ...
  /* "deepcell/utils/compute_overlap.pyx":27
 *     cdef unsigned int N = boxes.shape[0]
 *     cdef unsigned int K = query_boxes.shape[0]
 *     cdef np.ndarray[double, ndim=2] overlaps = np.zeros((N, K), dtype=np.float64)             # <<<<<<<<<<<<<<
 *     cdef double iw, ih, box_area
 ...
 */
  ...
  /* "deepcell/utils/compute_overlap.pyx":31
 *     cdef double ua
 ...
 */
  ...
  for (__pyx_t_9 = 0; __pyx_t_9 < __pyx_t_8; __pyx_t_9+=1) {
    ...
    /* "deepcell/utils/compute_overlap.pyx":33
 *     for k in range(K):
 *         box_area = (
 *             (query_boxes[k, 2] - query_boxes[k, 0] + 1) *             # <<<<<<<<<<<<<<
 ...
 */
    ...
    /* "deepcell/utils/compute_overlap.pyx":34
 *         box_area = (
 *             (query_boxes[k, 2] - query_boxes[k, 0] + 1) *
 *             (query_boxes[k, 3] - query_boxes[k, 1] + 1)             # <<<<<<<<<<<<<<
 *         )
 ...
 */
    ...
    /* "deepcell/utils/compute_overlap.pyx":36
 *             (query_boxes[k, 3] - query_boxes[k, 1] + 1)
 *         )
 *         for n in range(N):             # <<<<<<<<<<<<<<
 *             iw = (
 ...
 */
    ...
    for (__pyx_t_21 = 0; __pyx_t_21 < __pyx_t_20; __pyx_t_21+=1) {
      ...
      /* "deepcell/utils/compute_overlap.pyx":38
 *         for n in range(N):
 *             iw = (
 *                 min(boxes[n, 2], query_boxes[k, 2]) -             # <<<<<<<<<<<<<<
 ...
 */
      ...
      /* "deepcell/utils/compute_overlap.pyx":39
 *             iw = (
 *                 min(boxes[n, 2], query_boxes[k, 2]) -
 *                 max(boxes[n, 0], query_boxes[k, 0]) + 1             # <<<<<<<<<<<<<<
 *             )
 ...
 */
      ...
      /* "deepcell/utils/compute_overlap.pyx":41
 *                 max(boxes[n, 0], query_boxes[k, 0]) + 1
 *             )
 *             if iw > 0:             # <<<<<<<<<<<<<<
 *                 ih = (
 ...
 */
      ...
      if (__pyx_t_34) {
        ...
        /* "deepcell/utils/compute_overlap.pyx":43
 *             if iw > 0:
 *                 ih = (
 *                     min(boxes[n, 3], query_boxes[k, 3]) -             # <<<<<<<<<<<<<<
 ...
 */
        ...
        /* "deepcell/utils/compute_overlap.pyx":44
 *                 ih = (
 *                     min(boxes[n, 3], query_boxes[k, 3]) -
 *                     max(boxes[n, 1], query_boxes[k, 1]) + 1             # <<<<<<<<<<<<<<
 *                 )
 ...
 */
        ...
        /* "deepcell/utils/compute_overlap.pyx":46
 *                     max(boxes[n, 1], query_boxes[k, 1]) + 1
 *                 )
 *                 if ih > 0:             # <<<<<<<<<<<<<<
 *                     ua = np.float64(
 ...
 */
        ...
        if (__pyx_t_34) {
          ...
          /* "deepcell/utils/compute_overlap.pyx":47
 *                 )
 *                 if ih > 0:
 *                     ua = np.float64(             # <<<<<<<<<<<<<<
 *                         (boxes[n, 2] - boxes[n, 0] + 1) *
 ...
 */
          ...
          /* "deepcell/utils/compute_overlap.pyx":48
 *                 if ih > 0:
 *                     ua = np.float64(
 *                         (boxes[n, 2] - boxes[n, 0] + 1) *             # <<<<<<<<<<<<<<
 *                         (boxes[n, 3] - boxes[n, 1] + 1) +
 ...
 */
          ...
          /* "deepcell/utils/compute_overlap.pyx":49
 *                     ua = np.float64(
 *                         (boxes[n, 2] - boxes[n, 0] + 1) *
 *                         (boxes[n, 3] - boxes[n, 1] + 1) +             # <<<<<<<<<<<<<<
 *                         box_area - iw * ih
 ...
 */
          ...
          /* "deepcell/utils/compute_overlap.pyx":50
 *                         (boxes[n, 2] - boxes[n, 0] + 1) *
 *                         (boxes[n, 3] - boxes[n, 1] + 1) +
 *                         box_area - iw * ih             # <<<<<<<<<<<<<<
 *                     )
 ...
 */
          ...
          /* "deepcell/utils/compute_overlap.pyx":52
 *                         box_area - iw * ih
 *                     )
 *                     overlaps[n, k] = iw * ih / ua             # <<<<<<<<<<<<<<
 *     return overlaps
 ...
 */
  ...
  /* "deepcell/utils/compute_overlap.pyx":53
 *                     )
 *                     overlaps[n, k] = iw * ih / ua
 *     return overlaps             # <<<<<<<<<<<<<<
 */
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_deepcell_utils_compute_overlap, __pyx_k_deepcell_utils_compute_overlap, sizeof(__pyx_k_deepcell_utils_compute_overlap), 0, 0, 1, 1},
  {&__pyx_kp_s_deepcell_utils_compute_overlap_p, __pyx_k_deepcell_utils_compute_overlap_p, sizeof(__pyx_k_deepcell_utils_compute_overlap_p), 0, 0, 1, 0},
 ...
 */
  ...
  __pyx_codeobj__9 = (PyObject*)__Pyx_PyCode_New(2, 0, 11, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__8, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_deepcell_utils_compute_overlap_p, __pyx_n_s_compute_overlap, 13, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__9)) __PYX_ERR(0, 13, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_deepcell__utils__compute_overlap) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "deepcell.utils.compute_overlap")) {
      if (unlikely(PyDict_SetItemString(modules, "deepcell.utils.compute_overlap", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "deepcell/utils/compute_overlap.pyx":9
 * 
 * cimport cython
 * import numpy as np             # <<<<<<<<<<<<<<
 * cimport numpy as np
 ...
 *     np.ndarray[double, ndim=2] query_boxes
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_8deepcell_5utils_15compute_overlap_1compute_overlap, NULL, __pyx_n_s_deepcell_utils_compute_overlap); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 13, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_compute_overlap, __pyx_t_1) < 0) __PYX_ERR(0, 13, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "deepcell/utils/compute_overlap.pyx":1
 * # --------------------------------------------------------             # <<<<<<<<<<<<<<
 * # Fast R-CNN
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init deepcell.utils.compute_overlap", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init deepcell.utils.compute_overlap");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
